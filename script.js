...
// ── Diamond SVG ──
function diamondSVG(position) {
  return '<svg class="position-diamond" viewBox="0 0 44 44" xmlns="http://www.w3.org/2000/svg">'
    ...
    + '<text x="22" y="27" text-anchor="middle" font-family="Caveat, cursive" font-size="11" font-weight="700" fill="#6b1a1a">' + position + '</text>'
    + '</svg>';
}
